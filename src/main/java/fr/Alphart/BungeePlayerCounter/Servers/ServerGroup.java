...
public class ServerGroup {
    ...
    private PingResponse lastPing = null;
    ...
    public ServerGroup(String name, List<String> servers, InetSocketAddress address, int updateInterval) {
        ...
        Bukkit.getScheduler().runTaskTimerAsynchronously(BPC.getInstance(), new PingTask(), 20L,
                20L * updateInterval);
    }
    ...
    /**
     * Check if this group contain the current server (server where the plugin
     * is running now)
     */
